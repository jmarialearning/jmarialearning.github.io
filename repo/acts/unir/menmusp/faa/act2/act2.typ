...
- #link("https://jmarialearning.github.io/repo/acts/unir/menmusp/faa/act2/sheet/12days.pdf")[12 days of Christmas. Arreglo original de Frederic Austin.]
== Noche de paz.
...
- La superdominante (VI) se utiliza con idéntico propósito a la obra citada anteriormente, es decir, para iniciar un 6-2-5-1. Además, construye el relativo menor de Fa Mayor.
- A partir del día 5, la estructura cambia con otra estrofa distinta. Se hace uso de varias dominantes secundarias, con el uso de acordes prestados de otras tonalidades y extraños, por tanto, a Fa mayor. La mediante (A) será su 5º grado.
=== Estructura.
La obra es acumulativa, es decir, cada estrofa se construye sobre la anterior, añadiendo iteraciones después del primer tema. A partir del quinto día, como se ha especificado, la estructura cambia y se siguen patrones con la dominante y subdominante. Dicha estructura viene iniciada mediante una dominante secundaria que resuelve a Do Mayor
=== Parámetros del sonido.
La tesitura de la línea melódica varía entre el Do4 y el Re5, medidos con el sistema científico (internacional). En lo que a la duración se refiere, tenemos principalmente negras y corcheas. Testimonialmente, aparecen notas de más duración cuando se quiere realizar una parada sobre una nota (_cf._ Día 5 y final).
=== Utilización y pertinencia en el aula de música.
Esta canción es de utilidad en el aula de música por varias razones:
- La canción es conocida en países anglosajones. Al ser acumulativa, se presta a ser aprendida en etapas, en lo referente a la letra. 
- La tesitura no es difícil. Incluso puede llegar a ser más sencilla que la obra anteriormente expuesta. En cualquier caso, abarca las tesituras de las voces blancas de Primaria.
- Habremos de comprobar que al cantar, las escalas y los saltos se realizan con calidad, aspecto no menor. A partir del 5º día, con la nueva estructura aparecen escalas y saltos que pueden necesitar trabajo para llegar a una buena interpretación
- Con ocasión de las fiestas navideñas, permite una situación social de referencia para trabajar aspectos musicales.
- Si mantenemos la música monótona, sin cambios tonales o modales, la canción puede llegar a ser espesa. Puede ser esto un inductor para experimentar acerca de los cambios de tonalidad, siempre desde el descubrimiento o las preguntas al alumnado.
