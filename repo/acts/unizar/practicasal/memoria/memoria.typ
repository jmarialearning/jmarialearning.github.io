...
Este colegio fue inicialmente una extensión del CEIP “Alto Aragón” dentro del edificio de un antiguo instituto técnico situado en la calle Antonio Machado Nº 5. Se designó definitivamente como colegio en 1981, dándole el nombre de Colegio Público “Pedro I”, en ese momento contaba con una vía en la etapa de infantil y primaria. El colegio fue creciendo y se hizo necesaria la construcción de un nuevo colegio, que se inauguró el 24 de septiembre de 2010.\
En la actualidad, el colegio acoge las etapas de Educación Infantil (2º Ciclo) y Educación Primaria. Es un colegio de máximo 3 vías y cuenta con un total de 21 unidades creadas: 6 Infantil y 13 de Primaria.\
...
Por otro lado, se ha podido ver el funcionamiento de un centro como una entidad consigue múltiples frentes abiertos, así como el funcionamiento de un evento grande de centro, como es un _festival de fin de curso_.\
Se ha podido mejorar la forma de trabajo con la supervisión de la tutora y adecuarla a los casos, habiendo cursado con aprovechamiento el periodo de prácticas de especialista AL.
...
- *Adecuación al aula de Educación Infantil*. Al ser la segunda vez que se intervenía en el aula de la etapa mencionada, los primeros días fueron complicados por las diferencias manifiestas que existen entre la forma de trabajar en Primaria con respecto a la existente en Infantil. Sin embargo, gracias a la disposición de la tutora y de las maestras de la etapa, se pasó correctamente el periodo de adaptación a la nueva dinámica con facilidad, llegando a trabajar sin problemas en el aula. La curva de aprendizaje al bajar de etapa, con una consiguiente pérdida de autonomía se ha compensado en los dos periodos en los que se ha intervenido en Educación Infantil.
...
- *Trabajo con alumnado con NEE*: el alumnado con NEE, derivadas de discapacidad visual o discapacidad auditiva, por ejemplo, requiere el conocimiento de diferentes actuaciones para permitir un mejor acceso a la información, como los equipos de FM, los _stands_ o los implantes cocleares, así como las lupas. El conocimiento de estos aparatos y su funcionamiento es vital para adecuar sus características a nuestro alumnado. Además, hemos de ser capaces de entender diferentes informaciones clínicas para poder trabajar de forma óptima con este tipo de estudiantes.\
En suma, las prácticas escolares de especialista de Audición y Lenguaje han supuesto un aprendizaje clave, que complementa a los académicos, para la práctica futura, en lo que a métodos, habilidades y formas de proceder se refiere. No se puede, a este respecto, más que agradecer al centro, especialmente a los docentes de atención a la diversidad, su presencia y disposición para resolver dudas y explicar las dinámicas, así como para permitir las intervenciones que se han estimado y dar _feedback_ formativo, cuando así ha sido procedente.
#bibliography(
  "fuentes.bib",
  title: "5. Referencias.",
